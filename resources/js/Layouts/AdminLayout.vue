                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <nav class="hidden md:flex ml-10 space-x-8">
                            ...
                            <Link v-if="can('coupons.read')" :href="route('admin.coupons')" class="text-sm font-medium whitespace-nowrap" :class="url.startsWith('/admin/coupons') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white'">Coupons</Link>
                            <Link v-if="can('settings.read')" :href="route('admin.settings')" class="text-sm font-medium whitespace-nowrap" :class="url.startsWith('/admin/settings') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white'">Settings</Link>
                            <Link v-if="can('admin.access')" :href="route('admin.activity-logs')" class="text-sm font-medium whitespace-nowrap" :class="url.startsWith('/admin/activity-logs') ? 'text-indigo-600 dark:text-indigo-400' : 'text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white'">Activity Logs</Link>
                        </nav>
                    </div>
